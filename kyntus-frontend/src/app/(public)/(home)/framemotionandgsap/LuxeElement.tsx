...
export default function LuxeElement({ 
  ...
  // 2. Idle Animations (Added 'none' to avoid index errors)
  ...
  // 3. Hover Animations (Added 'none' to avoid index errors)
  ...
  return (
    ...
    <motion.div 
      ...
      className={className}
    >
      {/* Couche 2: Continuous Idle Animation */}
      <motion.div 
        variants={idleVariants} 
        animate={idleType}
      >
        {/* Couche 3: Interactive Hover Effect */}
        <motion.div 
