...
export default function JobNodeCard({ offer, variants, onClick }: { offer: any, variants: any, onClick: () => void }) {
  ...
  return (
    ...
    >
      ...
      {/* ── 1. THE VISOR (Image that slides up) ── */}
      ...
      {/* ── 2. THE BLANC CASSÉ CORE (The Data Engine) ── */}
      <motion.div className={styles.mechCore} variants={coreVariants}>
        {/* Industrial Micro-Grid & Details */}
